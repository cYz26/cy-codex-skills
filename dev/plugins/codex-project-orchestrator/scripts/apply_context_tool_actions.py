...
def main() -> int:
    ...
    parser.add_argument("--all-safe", action="store_true", help="Select every action marked safe in the report.")
    parser.add_argument("--apply", action="store_true", help="Actually change files. Without this flag the command is dry-run.")
