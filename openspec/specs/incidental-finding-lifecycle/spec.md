# Incidental Finding Lifecycle Specification

## Purpose

Define how DevFlow classifies, bounds, persists, escalates, and discloses
incidental findings without displacing an approved critical path or granting
