...
- [x] GSD dependency checks, activation, and updater behavior use OpenGSD Core instead of legacy `get-shit-done-cc` / `gsd-sdk`.
...
| OpenGSD Core migration | done | `python3 -m unittest discover -s dev/plugins/dev-flow/tests -p 'test_dependencies.py'` passed: 24 tests; `python3 -m unittest discover -s dev/plugins/dev-flow/tests -p 'test_release_smoke.py'` passed: 18 tests |
...
- [x] DevFlow no longer requires or invokes legacy `gsd-sdk` / `get-shit-done-cc`; it validates project-local `.codex/gsd-core` and uses `@opengsd/gsd-core`.
...
- `python3 -m unittest discover -s dev/plugins/dev-flow/tests -p 'test_dependencies.py'` passed: 24 tests.
- `python3 -m unittest discover -s dev/plugins/dev-flow/tests -p 'test_release_smoke.py'` passed: 18 tests.
